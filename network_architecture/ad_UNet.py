...
from nnunet.network_architecture.adaptive_UNet_blocks import ConvDropoutNormNonlin, StackedConvLayers

class AdUNet(SegmentationNetwork):

    MAX_NUM_FILTERS_3D = 320
    
    def __init__(self, input_channels, num_classes, num_pool, num_conv_per_stages,
                 pool_op_kernel_sizes=None,
                 conv_kernel_sizes=None):
       
        assert len(num_conv_per_stages) == num_pool * 2 + 1
        ...
        self.final_nonlin = lambda x:x  # 什么情况
        ...
        for d in range(num_pool+1):
            ...
            # add convolutions
            self.conv_blocks_context.append(StackedConvLayers(input_features, output_features, num_conv_per_stages[d],
        ...
        for u in range(num_pool):
            ...
            self.conv_blocks_localization.append(StackedConvLayers(n_features_after_tu_and_concat, nfeatures_from_skip, num_conv_per_stages[num_pool+1+u],

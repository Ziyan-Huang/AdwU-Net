# Adaptive width U-Net for search
...
from nnunet.network_architecture.adaptive_UNet_blocks import AdaptiveWidthConvDropoutNormNonlin, AdaptiveWidthStackedConvLayers
    

class AwUNet_search(SegmentationNetwork):
    
    def __init__(self, input_channels, num_classes, num_pool, num_conv_per_stage,
                pool_op_kernel_sizes=None,
                conv_kernel_sizes=None):
       
        super(AwUNet_search, self).__init__()
        ...
        for d in range(num_pool+1):
            ...
            # add convolutions
            self.conv_blocks_context.append(AdaptiveWidthStackedConvLayers(input_features, output_features, num_conv_per_stage,
        ...
        for u in range(num_pool):
            ...
            self.conv_blocks_localization.append(AdaptiveWidthStackedConvLayers(n_features_after_tu_and_concat, nfeatures_from_skip, num_conv_per_stage,
